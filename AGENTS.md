...
- Writing and running automated tests is allowed and encouraged when it is useful. Run tests only from the console; do not interact with the Unity Test Runner or other Unity UI manually.
